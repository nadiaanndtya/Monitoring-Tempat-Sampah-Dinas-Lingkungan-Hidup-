...
<head>
  ...
  <meta name="petugas-nama" content="{{ session('nama') }}">
  <meta name="mobil-id" content="{{ session('mobil_id') }}">
  ...
  <style>
    ...
    .leaflet-tooltip.tps-tooltip:before{
  ...
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        ...
        Dinas Lingkungan Hidup - Petugas
      </a>
      <div class="d-flex">
        <button id="btnRute" class="logout-btn me-2" onclick="displayOptimizedRoute()">
          <i class = "bi bi-geo-alt-fill"> </i> Cari Rute Terdekat</button>

        <button id="btnCancelRute" class="logout-btn logout-btn-cancel me-2 d-none">
          <i class="bi bi-x-circle"></i> Batalkan Rute
        </button>

        <button id="btnProfil" class="logout-btn me-2" style="position: relative; index: 2050;">
          <i class="fas fa-user-circle"></i> Profil </button>
        <a href="{{ route('logout') }}">
