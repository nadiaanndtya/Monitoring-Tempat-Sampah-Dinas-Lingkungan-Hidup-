...
<head>
  ...
  <title>Login Petugas/Admin | DLH Parepare</title>
  ...
  <style>
    ...
    *{ box-sizing:border-box; margin:0; padding:0; }
    ...
    .card-head{ flex:1; min-width:240px; }
...
<body>
          ...
          <div class="card">
            ...
            <div class="card-top">
              ...
              <div class="card-actions">
                <a class="back" href="{{ route('login.warga') }}">
                  <i class="fa-solid fa-user"></i> Login Warga
                </a>
            ...
            <form id="loginFormStaff"action="{{ route('login.staff.submit') }}" method="POST" autocomplete="on">
              @csrf
              ...
              <div class="field">
                ...
                <div class="control">
                  ...
                  <input
                    ...
                    id="email"
                    name="email"
                    placeholder="contoh: petugas@dlh.go.id"
                    required
                  >
                </div>
              </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      const form = document.getElementById('loginFormStaff');
